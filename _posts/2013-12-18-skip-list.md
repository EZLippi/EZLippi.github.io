...
现在我们考虑一个有序的链表：
 ...
 ![](/assets/images/githubpages/skiplist1.jpg)
...
节点提取出来，作为索引。得到如下结构：
 ![](/assets/images/githubpages/skiplist2.jpg)
...
如图所示。
 ![](/assets/images/githubpages/skiplist3.jpg)
...
比如插入key为25的节点，如下图:
 ![](/assets/images/githubpages/skiplist4.jpg)
 
对于步骤1,我们需要对于每一层进行遍历并保存这一层中下降的节点(其后继节点为NULL或者后继节点的key大于等于要插入的key)，如下图,
 ![](/assets/images/githubpages/skiplist5.jpg)
...
skiplist分析如下图
  ![](/assets/images/githubpages/skiplist6.jpg)
