...
先来看看minor Compaction的过程。Minor compaction 的目的是当内存中的memtable大小到了一定值时，将内容保存到磁盘文件中，图8.1是其机理示意图。 ![](/assets/images/githubpages/level11.png)
...
图8.2说明了这一过程。
![](/assets/images/githubpages/level12.png)
