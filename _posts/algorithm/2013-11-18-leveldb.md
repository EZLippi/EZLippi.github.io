...
![](/assert/images/githubpages/level1.png)
图1.1：LevelDb结构
...
![](/assert/images/githubpages/level2.png)
图2.1：Manifest存储示意图
...
![](/assert/images/githubpages/level3.png)
图3.1 log文件布局
...
![](/assert/images/githubpages/level4.png)
图4.1 .sst文件的分块结构
...
![](/assert/images/githubpages/level5.png)
图4.2 逻辑布局
...
![](/assert/images/githubpages/level6.png)
图4.3 数据索引
...
![](/assert/images/githubpages/level7.png)
图4.5 数据Block内部结构
...
![](/assert/images/githubpages/level8.png)
图4.6 记录格式
...
![](/assert/images/githubpages/level9.png)
图6.1 LevelDb写入记录
...
![](/assert/images/githubpages/level10.png)
图7-1  LevelDb读取记录流程
...
先来看看minor Compaction的过程。Minor compaction 的目的是当内存中的memtable大小到了一定值时，将内容保存到磁盘文件中，图8.1是其机理示意图。 ![](/assert/images/githubpages/level11.png)
...
图8.2说明了这一过程。
![](/assert/images/githubpages/level12.png)
